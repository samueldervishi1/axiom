...
public class DevToolsService {
    ...
    private String getProjectAgeWithExistentialCrisis() {
        long days = getDaysSinceStart();
        int deletedRepos = 7;

        String[] messages = {
                "Project running for " + days + " days (deleted " + deletedRepos + " times, but who's counting?)",
                "Survived " + days + " days despite " + deletedRepos + " 'rm -rf' moments of rage",
                days + " days old, reborn " + deletedRepos + " times like a caffeinated phoenix",
                "Day " + days + " of pretending this will work (previous " + deletedRepos + " attempts don't count)",
