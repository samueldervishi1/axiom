...
import com.axiom.server.services.AxiomService;
...
public class ChattrUltraController {
    ...
    public ChattrUltraController(AxiomService axiomService) {
    ...
    public ResponseEntity<Axiom> askQuestion(@RequestBody ChatRequest chatRequest) {
        ...
        Axiom response = axiomService.sendQuestionToModel(chatRequest);
    ...
    public ResponseEntity<List<Axiom>> getConversationHistory(@PathVariable String conversationId) {
        ...
        List<Axiom> history = axiomService.getConversationHistory(conversationId);
